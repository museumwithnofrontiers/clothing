...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'Clothing and Costume',
  ...
  // one entry for every project id `npm pack @museumwnf/clothing-data`
  // carries in `manifest.projects` (checked 2026-09-19, clothing-data 1.0.9).
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/clothing' },
