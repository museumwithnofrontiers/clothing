...
export default {
  ...
  home: {
    title: 'clothing.identity.title',
    intro: 'clothing.home.intro',
    cards: [
      {
        title: 'clothing.nav.catalogue',
        description: 'clothing.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'clothing.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'clothing.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'clothing.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'clothing.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'clothing.partnerObjects.emptyPartner',
  //         emptyInstitution: 'clothing.partnerObjects.emptyInstitution',
  //         institutionSummary: 'clothing.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'clothing.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'clothing.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
