...
// `useGalleryData.js` used to be byte-identical local copies of what clothing
...
// legacy project key, no UUID — clothing shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (clothing-data 1.0.11+), an outside
