...
The **Museum With No Frontiers — Clothing and Costume** gallery, built from the published
dataset `@museumwnf/clothing-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/clothing-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/clothing/> through the reusable workflows in
